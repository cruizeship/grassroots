...
def run_script():
    ...
    {all_articles} If it's not related to the selected topics and/or it's not in {location}, don't account for it. If it's an opinion article or a guide, don't account for it.
